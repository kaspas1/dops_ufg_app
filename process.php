...
if($_SERVER["REQUEST_METHOD"]==="GET"){
	...
	switch($tipo_peticion){
		...
		break;
		case "insert":
			$resultado = $Persona->nuevaPersona("DISRAELY OMAR","PASTOR SOLORZANO","1977-03-14","7557-7755","ia.pastor2012@ufg.edu.sv");
		break;
		default:
			header('HTTP/1.1 403 Forbidden');
			$resultado = array("mensaje"=>"Sebe indicar el tipo de procesamiento de datos a realizar", "valores"=>"");
		break;
	}
